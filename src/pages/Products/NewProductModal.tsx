...
const NewProductModal:React.FC<NewProductModalProps> = ({isOpen, onClose, onSave}) => {
  ...
  return (
    ...
    <div className="modal-content">
      ...
      <button type="button" onClick={handleSubmit} className="action-btn save-btn">Save</button>
      <button type="button" onClick={onClose} className="action-btn close-btn">Close</button>
    </div>
  </div>
  )
}
